...
export default defineConfig([
  ...
  {
    // Test files (and shared test setup) may use the `any` type, PascalCase
    // mock components (`const Outlet = () => ...`), `useXxxMock` helpers, and
    // unawaited mock promises in ways we want to prevent in normal code.
